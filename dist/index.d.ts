...
type InputType = "color" | "date" | "datetime-local" | "email" | "month" | "number" | "password" | "range" | "search" | "tel" | "text" | "time" | "url" | "week";
/**
...
interface InputProps extends BaseProps {
     ...
     */
    onChange?: (newValue: string | number | string[] | undefined, oldValue?: string | number | string[] | undefined, currentComponent?: EventTarget & HTMLInputElement) => void;
    /**
     * @property onKeyDown
 ...
 */
declare const Input: React.ForwardRefExoticComponent<InputProps & React.RefAttributes<Partial<HTMLInputElement> & {
    focus: () => void;
    getValue: () => string;
 ...
 */
declare const useInput: (defValue: string | number | string[] | undefined) => [string | number | string[], (newValue: string | number | string[] | undefined) => void];
 ...
 */
declare const useRandomId: ([prefix, suffix]?: string[]) => string;
